            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Menu</span><i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">

                        <li><a href="{{ route('menus.create') }}" class="slide-item" >Add Menu</a></li>

                        <li><a href="{{ route('menus.index') }}" class="slide-item">List Menus</a></li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('pages.create') }}" class="slide-item" >Add Page</a></li>

                        <li><a href="{{ route('pages.index') }}" class="slide-item">List Pages</a></li>
