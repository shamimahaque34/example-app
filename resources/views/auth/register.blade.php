                ...
                <div class="card-body">
                    <form action="{{ route('register') }}" method="post" class="login100-form validate-form">
                        ...
                        <div class="wrap-input100 validate-input" data-bs-validate = "Valid email is required: ex@abc.xyz">
                            ...
                            <span class="symbol-input100"><i class="mdi mdi-account" aria-hidden="true"></i></span>
                        </div>
                        <div class="wrap-input100 validate-input" data-bs-validate = "Valid email is required: ex@abc.xyz">
                        ...
                        <div class="wrap-input100 validate-input" data-bs-validate = "Mobile is required">
...
{{--                                Register--}}
{{--                            </a>--}}
                            <button type="submit" class="login-btn login100-form-btn btn-primary">Register</button>
                        </div>
